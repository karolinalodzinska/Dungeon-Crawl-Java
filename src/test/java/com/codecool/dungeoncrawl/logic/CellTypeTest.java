...
public class CellTypeTest {
    ...
    // negative test cases
    @Test
    public void getTileName_Empty_ReturnsAnotherCellType() {
        CellType floor = CellType.EMPTY;
    ...
    @Test
    public void getTileName_Floor_ReturnsAnotherCellType() {
        CellType floor = CellType.FLOOR;
    ...
    @Test
    public void getTileName_Wall_ReturnsAnotherCellType() {
    ...
    @Test
    public void getTileName_OpenDoor_ReturnsAnotherCellType() {
    ...
    @Test
    public void getTileName_ClosedDoor_ReturnsAnotherCellType() {
